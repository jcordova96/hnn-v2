...
<div id="mc_embed_signup" style="text-align: left;">
    <form action="//hnn.us1.list-manage.com/subscribe/post?u=191ccdd6c73c5afeafd52cfb8&amp;id=4b27cc9cc2"
          class="validate well" id="mc-embedded-subscribe-form" method="post" name="mc-embedded-subscribe-form"
          target="_blank">
        <h4>Join our mailing list</h4>

        <div class="mc-field-group" style="clear: both;">

            <input class="required email span2" id="mce-EMAIL" name="EMAIL" type="text" value="" placeholder="Your email address*">
        </div>
        ...
        <div>
            <input class="btn" id="mc-embedded-subscribe" name="subscribe" style="clear: both; width: auto; display: block;" type="submit" value="Subscribe"></div>
