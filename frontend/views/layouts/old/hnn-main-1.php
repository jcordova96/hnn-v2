...
$route = Yii::app()->controller->route . "/" . Yii::app()->getRequest()->getQuery('id');
...
<head>
    ...
    <title><?php echo isset($this->currentArticleTitle) ? $this->currentArticleTitle . " | " : ""; ?> History News
        Network</title>
    ...
    <header id="header">
        <div class="row">
            ...
            <div class="span6 logo">
                <a href="/"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/hnn/hnn-logo-march2017-2.jpg"
                                 alt="Logo"/></a>
            </div>
            <!-- /.span3.logo -->
            ...
            <!-- .span3.logo
        <div class="span6 logo">
            <a href="/"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/hnn/hnn-logo-new.jpg"
                             alt="Logo"/></a>
        </div>
        -->
    </header>
